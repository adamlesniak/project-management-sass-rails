class UserProjectsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_tenant_project_url(id: @user_project.project_id,
                    tenant_id: @user_project.project.user_id),
                    notice: 'User project was successfully removed from the project.' }
    end
  end
